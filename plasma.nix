{
  programs.plasma = {
    enable = true;
    shortcuts = {
      ActivityManager.switch-to-activity-6bc54b00-89e8-4da2-9b8d-ff54e9540987 = [ ];
    ...
    configFile = {
      ...
      dolphinrc.General.ViewPropsTimestamp = "2026,8,5,18,6,59.146";
      dolphinrc."KFileDialog Settings"."Places Icons Auto-resize" = false;
      dolphinrc."KFileDialog Settings"."Places Icons Static Size" = 22;
      kactivitymanagerdrc.activities."6bc54b00-89e8-4da2-9b8d-ff54e9540987" = "Default";
      ...
      kdeglobals.General.BrowserApplication = "brave-origin.desktop";
      ...
      kwinrc.Desktops.Id_1 = "91433132-911e-4b20-9f43-b38edbcd8f6c";
      kwinrc.Desktops.Number = 1;
      kwinrc.Desktops.Rows = 1;
      kwinrc."Tiling/91433132-911e-4b20-9f43-b38edbcd8f6c/caff84ca-bcbb-4338-af75-3ffab6da63d3".padding = 4;
      kwinrc."Tiling/91433132-911e-4b20-9f43-b38edbcd8f6c/caff84ca-bcbb-4338-af75-3ffab6da63d3".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      kwinrc.Xwayland.Scale = 1;
      kwinrulesrc.General.rules = "";
      plasma-localerc.Formats.LANG = "en_US.UTF-8";
    };
    dataFile = {
      "kate/anonymous.katesession"."Document 0".URL = "file:///home/matteo/git url command";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-H-Splitter = "0,1893,0";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-Splitter = 865;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-1-Splitter = 865;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-2-Splitter = 1893;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-Splitter = 1646;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-V-Splitter = "0,865,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0".Sizes = 1893;
